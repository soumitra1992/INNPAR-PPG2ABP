...
def get_guided_model_flops(model, input_res,input_res2, print_per_layer_stat=True,
    ...
    if input_constructor:
        ...
        batch1 = torch.FloatTensor(1, *input_res).to(device)
        batch2 = torch.FloatTensor(1, *input_res2).to(device)
        _ = flops_model(batch1,batch2)
